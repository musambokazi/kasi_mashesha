...
export default function RunnerProfile() {
    ...
    const [name, setName] = useState('Sipho Dlamini');
    const [email, setEmail] = useState('sipho@runner.com');
    const [phone, setPhone] = useState('083 555 1234');
    const [vehicleType, setVehicleType] = useState('Motorbike - Honda Ace');
    const [licensePlate, setLicensePlate] = useState('GP 123 AB');
        ...
        <SafeAreaView style={styles.container}>
            <ScrollView contentContainerStyle={styles.scrollContent}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.role}>Runner</Text>
                    <Text style={styles.statusBadge}>Status: Active</Text>
                </View>

                {/* PERSONAL DETAILS */}
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>Runner Details</Text>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.inputGroup}>
                        ...
                        <TextInput style={styles.input} value={vehicleType} onChangeText={setVehicleType} placeholder="e.g. Motorbike, Bicycle, Car" />
                    </View>
...
const styles = StyleSheet.create({
    ...
    statusBadge: { marginTop: 5, color: '#006400', fontWeight: 'bold' },
